            ...
            <table class="table table--responsive--lg custom--table">
                ...
                <tbody>
                    @forelse($deposits as $deposit)
                        @if($deposit->transaction_type == 2)
                            <tr>
                                <td>
                                    <div class="td-wrapper">
                                        <span class="Wallet Credit d-block"><b>Wallet Debit</b></span>
                                        <span class="info"> For Purchase</span>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        @if ($deposit->status == Status::ORDER_PAID)
                        ...
                        @else
                            <tr>
                                <td>
                                    <div class="td-wrapper">
                                        <span class="Wallet Credit d-block"><b>Wallet Credit</b></span>
                                        <span class="info">{{ __($deposit->gateway?->name) }}</span>
