                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            @forelse($orders as $order)
                                ...
                                <tr>
                                    <td>
                                        <span class="fw-bold">{{ $order->user->fullname ?? "name" }}</span>
                                        <br>
                                        <span class="small"> <a href="{{ appendQuery('search',$order->user->username ?? "name" ) }}"><span>@</span>{{ $order->user->username ?? "name" }}</a> </span>
                                    </td>
